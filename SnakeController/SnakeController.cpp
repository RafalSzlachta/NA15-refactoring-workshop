...
{
    int eventIntNumber = e->getMessageId();

    switch(eventIntNumber)
    {
    case(TimeoutInd::MESSAGE_ID) : handleTimePassed(*static_cast<EventT<TimeoutInd> const&>(*e));
        break;
    case(DirectionInd::MESSAGE_ID) : handleDirectionChange(*static_cast<EventT<DirectionInd> const&>(*e));
        break;
    case(FoodInd::MESSAGE_ID) : handleFoodPositionChange(*static_cast<EventT<FoodInd> const&>(*e));
        break;
    case(FoodResp::MESSAGE_ID) : handleNewFood(*static_cast<EventT<FoodResp> const&>(*e));
        break;
